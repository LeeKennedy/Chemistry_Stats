...
##Demonstration Data##
```{r}
cancer.survival <- read_csv("~/Desktop/R Holding/Statistics Notebooks/data/cancer-survival.csv")
```
...
```{r}
val_data <- read_excel("~/Desktop/R Holding/Statistics Notebooks/data/Validation.xlsx")
round(val_data,2)
```
...
### Data ###
```{r}
moth.experiment <- read_csv("~/Desktop/R Holding/Statistics Notebooks/data/moth-trap-experiment.csv")
str(moth.experiment)
```
